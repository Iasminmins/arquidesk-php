...
{
    return [
        'ESSENCIAL' => ['name' => 'Start', 'legacy' => 'ESSENCIAL', 'price' => 149, 'priceLabel' => 'R$ 149/mês', 'users' => 'Proprietário + até 4 usuários', 'userLimit' => 5, 'description' => 'Para empresas pequenas que querem sair das planilhas e organizar a operação.', 'highlighted' => false, 'badge' => ''],
        'PROFISSIONAL' => ['name' => 'Profissional', 'legacy' => 'PROFISSIONAL', 'price' => 297, 'priceLabel' => 'R$ 297/mês', 'users' => 'Proprietário + até 8 usuários', 'userLimit' => 9, 'description' => 'Para empresas que precisam controlar projetos, financeiro, metas e equipe.', 'highlighted' => true, 'badge' => 'Mais escolhido'],
        'PREMIUM' => ['name' => 'Business', 'legacy' => 'PREMIUM', 'price' => 497, 'priceLabel' => 'R$ 497/mês', 'users' => 'Proprietário + até 15 usuários', 'userLimit' => 16, 'description' => 'Para operações maiores que precisam de mais usuários, controle e suporte.', 'highlighted' => false, 'badge' => ''],
    ];
}
